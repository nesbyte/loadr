...
var index = loadr.NewTemplate(base, "index.html", IndexData{}, true)
var data = loadr.NewTemplate(base, "business-data", BuisnessData{}, false)
var profit = loadr.NewTemplate(base, "profit", BuisnessData{}.Profit, false)
